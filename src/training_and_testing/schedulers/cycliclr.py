...
def scheduler(optimizer, base_lr: float = 1e-6, max_lr: float = 1e-3, step_size_up: int = 5000, step_size_down: int = 10000, mode: str = "triangular2", **kwargs) -> Tuple[CyclicLR, int]:
    """
