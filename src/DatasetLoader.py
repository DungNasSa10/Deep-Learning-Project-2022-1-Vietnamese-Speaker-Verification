...
class AugmentWAV(object):
	...
	def additive_noise(self, noisecat, audio):
		"""
		this augmentation based on
		https://trepo.tuni.fi/bitstream/handle/10024/117251/EklundVille-Veikko.pdf?sequence=2

		Return
		Noise that is summed with the original signal
		"""
