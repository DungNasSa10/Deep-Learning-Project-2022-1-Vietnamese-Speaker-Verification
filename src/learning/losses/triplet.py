...
class Triplet(nn.Module):
    ...
    def __init__(self, hard_rank=0, hard_prob=0, margin=0):
    ...
    def forward(self, x, label=None):
        ...
        errors = tune_threshold_from_score(scores, labelnp, [])
...
def loss_init(hard_rank=0, hard_prob=0, margin=0, **kwargs):
    return Triplet(hard_rank=hard_rank, hard_prob=hard_prob, margin=margin)
